...
:HTML_CONTAINER_CLASS: badge
:END:
- For this activity you need to produce a presentation on current AI technologies.
...
- Your presentation needs to be a PowerPoint presentation - A slide show, poster or video for instance.
