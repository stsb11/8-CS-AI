...
#+end_html
#+begin_html
<iframe width="560" height="315" src="https://www.youtube.com/embed/z9uLb7-eJD8" frameborder="0" allowfullscreen></iframe>
#+end_html
#+begin_html
...
:HTML_CONTAINER_CLASS: badge
:END:
- *Underneath the table you produced for the silver badge, answer the following questions.*
